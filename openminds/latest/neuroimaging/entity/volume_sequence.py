...
class VolumeSequence(LinkedMetadata):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/VolumeSequence"
    ...
    properties = [
        ...
        Property(
            ...
            required=True,
            description="no description available",
            instructions="Enter the total number of volumes in this volume sequence (at least two).",
        ),
        Property(
            "temporal_resolution",
