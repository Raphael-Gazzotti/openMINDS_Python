...
class CustomAnnotation(EmbeddedMetadata):
    ...
    properties = [
        ...
        Property(
            "coordinate_space",
            ["openminds.v1.sands.CommonCoordinateSpaceVersion", "openminds.v1.sands.CustomCoordinateSpace"],
            "coordinateSpace",
            required=True,
        ...
        Property(
            "criteria_type",
            "openminds.v1.controlled_terms.AnnotationCriteriaType",
            "criteriaType",
            required=True,
            description="no description available",
        ...
        Property(
            ...
            "openminds.v1.sands.ViewerSpecification",
        ...
        Property(
            "specification",
            ["openminds.v1.core.File", "openminds.v1.core.PropertyValueList"],
            "specification",
        ...
        Property(
            "type",
            "openminds.v1.controlled_terms.AnnotationType",
            "type",
            required=True,
