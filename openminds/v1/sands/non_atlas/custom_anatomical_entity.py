...
class CustomAnatomicalEntity(LinkedMetadata):
    ...
    properties = [
        Property(
            "has_annotations",
            "openminds.v1.sands.CustomAnnotation",
            "hasAnnotation",
            multiple=True,
            unique_items=True,
            min_items=1,
        ...
        Property(
            "related_uberon_term",
            ["openminds.v1.controlled_terms.Organ", "openminds.v1.controlled_terms.UBERONParcellation"],
            "relatedUBERONTerm",
            description="no description available",
        ...
        Property(
            ...
            ["openminds.v1.sands.QualitativeRelationAssessment", "openminds.v1.sands.QuantitativeRelationAssessment"],
            "relationAssessment",
            multiple=True,
            unique_items=True,
            min_items=1,
