...
class Setup(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "has_parts",
            ["openminds.v1.core.Setup", "openminds.v1.core.SoftwareVersion"],
            "hasPart",
            multiple=True,
            unique_items=True,
            min_items=2,
        ...
        Property(
            "manufacturers",
            ["openminds.v1.core.Consortium", "openminds.v1.core.Organization", "openminds.v1.core.Person"],
            "manufacturer",
            multiple=True,
            unique_items=True,
            min_items=1,
        ...
        Property(
            "types",
            "openminds.v1.controlled_terms.SetupType",
            "type",
            multiple=True,
            unique_items=True,
            min_items=1,
