...
class ImageStack(LinkedMetadata):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/ImageStack"
    ...
    properties = [
        ...
        Property(
            ...
            description="Word or phrase that constitutes the distinctive designation of the image stack.",
        ...
        Property(
            ...
            required=True,
            description="no description available",
            instructions="Enter the total number of images in this stack (at least two).",
        ),
        Property(
            "pixel_sizes",
            "openminds.latest.core.QuantitativeValue",
        ...
        Property(
            ...
            "sliceThickness",
            description="no description available",
            instructions="Enter the thickness of each image slice in the stack.",
        ),
    ]
