...
class StructuralMRIAcquisition(LinkedMetadata):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/StructuralMRIAcquisition"
    ...
    properties = [
        ...
        Property(
            ...
            multiline=True,
            description="Longer statement or account giving the characteristics of the structural m r i acquisition.",
